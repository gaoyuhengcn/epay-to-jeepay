...
//第三步，查重
$my_trade_no = $data['mchOrderNo'];  //本系统订单号
$pay_trade_no = $data['payOrderId']; //payment订单号
$money = $data['amount'];            //金额

//如果上边系统下来的订单号=本地系统的订单号，金额相等
if($my_trade_no == TRADE_NO && $money==strval($order['money']*100)){
